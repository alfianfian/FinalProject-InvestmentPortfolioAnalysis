...
#
# use first 3 eigen-vectors to compue single factor (with normalization to have pos correlation with market)
...
p3 = p3/colSums(p3)
p3
barplot(p3, horiz=F, main="Factor mimicking weights", col="blue", cex.names = 0.75, las=2)
